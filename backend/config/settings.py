...
SECRET_KEY = config("SECRET_KEY", default="this-is-no-secret")
...
DATABASES = {
    "default": {
        "ENGINE": config("DATABASE_ENGINE", "django.db.backends.postgresql_psycopg2"),
        "NAME": config("DATABASE_NAME", "uptime"),
        "USER": config("DATABASE_USER", "postgres"),
        "PASSWORD": config("DATABASE_PASS", "pudop"),
